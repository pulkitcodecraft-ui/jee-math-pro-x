  ...
  return (
    <>
      <button
        ...
        className="mt-4 sm:mt-0 sm:absolute sm:bottom-4 sm:right-4 z-10 w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 sm:px-3 sm:py-1.5 rounded-full
                   bg-gradient-to-r from-primary to-primary-light text-white text-sm sm:text-xs font-medium
