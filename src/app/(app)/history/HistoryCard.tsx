      ...
      <div className="absolute top-4 right-4">
        {confirming ? (
          ...
          <button
            ...
            className="w-7 h-7 rounded-lg flex items-center justify-center text-text-dim opacity-70 sm:opacity-0 sm:group-hover:opacity-100 focus:opacity-100 hover:text-rose-400 hover:bg-rose-500/10 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 touch-visible"
          >
